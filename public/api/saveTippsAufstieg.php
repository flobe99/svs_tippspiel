...
foreach ($data as $tip) {
    ...
    $checkQuery = "SELECT _id FROM SpieleAufstieg WHERE _id = :spiel_id";
    $stmt = $conn->prepare($checkQuery);
    ...
    $query = "INSERT INTO TippsAufstieg (personen_id, spiele_id, Heim, Gast) VALUES (:person_id, :spiel_id, :heim, :gast)";
