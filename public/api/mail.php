...
$message = "Danke " . $data['person_data']['firstname'] . " " . $data['person_data']['lastname'] . " für die Teilnahme am Tippspiel.\n" .
           ...
           $matches .
           "\nEndplazierung 1. Mannschaft: " . $data['endplazierung']['Endplazierung_1'] . "\n" .
           "Endplazierung 2. Mannschaft: " . $data['endplazierung']['Endplazierung_2'] . "\n\n" .
           "Bitte bezahle 30€ bei deinem Tipppaten " . $data['person_data']['tipp_pate'] . " oder " .
           "per Paypal an sv-sulmetingen@web.de und gib deinen Vornamen, Nachnamen und E-Mail als Verwendungszweck an.";
